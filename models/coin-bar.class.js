class CoinBar extends DrawableObject {
    ...
    /**
    * Sets the number of coins (coinAmount) to a given value. 
   ...
   */
    resolveImageIndex() {
        if (this.coinAmount == 10)  return 5;
        else if (this.coinAmount >= 8) return 4;
        else if (this.coinAmount >= 6) return 3;
        else if (this.coinAmount >= 3) return 2;
        else if (this.coinAmount > 0)  return 1;
        else return 0;
    }
}